...
namespace PhysicSceneEditorControl.Controls.ActionSelect
{
    //Enthält die Logik, dass man Buttons selektieren kann
    public class ActionSelectViewModel : ReactiveObject
    {
        public enum Commands { Nothing, AddRectangle, AddCircle, AddPolygon, MoveRotate, MoveResize, CloneShape, AddDistanceJoint, AddRevoluteJoint, AddPrismaticJoint, AddWeldJoint, AddWheelJoint, LimitJoint, AddThruster, AddRotaryMotor, AddAxialFriction, EditProperties, EditCollisionMatrix, Delete }
        ...
        public ReactiveCommand<Unit, Unit> AddThrusterClick { get; private set; }
        public ReactiveCommand<Unit, Unit> AddRotaryMotorClick { get; private set; }
        public ReactiveCommand<Unit, Unit> AddAxialFrictionClick { get; private set; }
        public ReactiveCommand<Unit, Unit> EditPropertiesClick { get; private set; }
        public ReactiveCommand<Unit, Unit> EditCollisionMatrixClick { get; private set; }
        ...
        [Reactive] public Thickness AddPolygonBorderThickness { get; set; }
        ...
        [Reactive] public Thickness AddThrusterThickness { get; set; }
        [Reactive] public Thickness AddRotaryMotorThickness { get; set; }
        [Reactive] public Thickness AddAxialFrictionThickness { get; set; }
        [Reactive] public Thickness EditPropertiesBorderThickness { get; set; }
        [Reactive] public Thickness EditCollisionMatrixBorderThickness { get; set; }
        ...
        [Reactive] public Thickness AddPolygonMargin { get; set; }
        ...
        [Reactive] public Thickness AddThrusterMargin { get; set; }
        [Reactive] public Thickness AddRotaryMotorMargin { get; set; }
        [Reactive] public Thickness AddAxialFrictionMargin { get; set; }
        [Reactive] public Thickness EditPropertiesMargin { get; set; }
        [Reactive] public Thickness EditCollisionMatrixMargin { get; set; }
        [Reactive] public Thickness DeleteMargin { get; set; }

        public event Action<Commands> SelectedCommandChanged;

        [Reactive] public Visibility VisibilityAll { get; set; } = Visibility.Visible;
        ...
        public ActionSelectViewModel()
        {
            ...
            {
                this.SelectedCommand = Commands.AddPolygon;
            });
            ...
            this.AddThrusterClick = ReactiveCommand.Create(() =>
            {
                this.SelectedCommand = Commands.AddThruster;
            });
            this.AddRotaryMotorClick = ReactiveCommand.Create(() =>
            {
                this.SelectedCommand = Commands.AddRotaryMotor;
            });
            this.AddAxialFrictionClick = ReactiveCommand.Create(() =>
            {
                this.SelectedCommand = Commands.AddAxialFriction;
            });
            this.EditPropertiesClick = ReactiveCommand.Create(() =>
            {
                this.SelectedCommand = Commands.EditProperties;
            });
            this.EditCollisionMatrixClick = ReactiveCommand.Create(() =>
            {
                this.SelectedCommand = Commands.EditCollisionMatrix;
            });
        ...
        private void UpdateBorders(Commands value)
        {
            ...
            switch (value)
            {
                ...
                case Commands.AddPolygon:
                    this.AddPolygonBorderThickness = new Thickness(selectedThickness);
                    this.AddPolygonMargin = new Thickness(selectedMargin);
                    break;
                ...
                case Commands.AddThruster:
                    this.AddThrusterThickness = new Thickness(selectedThickness);
                    this.AddThrusterMargin = new Thickness(selectedMargin);
                    break;
                case Commands.AddRotaryMotor:
                    this.AddRotaryMotorThickness = new Thickness(selectedThickness);
                    this.AddRotaryMotorMargin = new Thickness(selectedMargin);
                    break;
                case Commands.AddAxialFriction:
                    this.AddAxialFrictionThickness = new Thickness(selectedThickness);
                    this.AddAxialFrictionMargin = new Thickness(selectedMargin);
                    break;
                ...
                case Commands.EditCollisionMatrix:
                    this.EditCollisionMatrixBorderThickness = new Thickness(selectedThickness);
                    this.EditCollisionMatrixMargin = new Thickness(selectedMargin);
                    break;
        ...
        private void SetAllButtonBorderThickness(double thickness)
        {
            ...
            this.AddPolygonBorderThickness = new Thickness(thickness);
            ...
            this.AddThrusterThickness = new Thickness(thickness);
            this.AddRotaryMotorThickness = new Thickness(thickness);
            this.AddAxialFrictionThickness = new Thickness(thickness);
            this.EditPropertiesBorderThickness = new Thickness(thickness);
            this.EditCollisionMatrixBorderThickness = new Thickness(thickness);
        ...
        private void SetAllButtonMargin(double thickness)
        {
            ...
            this.AddPolygonMargin = new Thickness(thickness);
            ...
            this.AddThrusterMargin = new Thickness(thickness);
            this.AddRotaryMotorMargin = new Thickness(thickness);
            this.AddAxialFrictionMargin = new Thickness(thickness);
            this.EditPropertiesMargin = new Thickness(thickness);
            this.EditCollisionMatrixMargin = new Thickness(thickness);
