...
namespace RigidBodyPhysics.UnitTests.CollisionResolution
{
    ...
    {
        private static string TestData = @"..\..\..\..\..\Data\TestData\RigidBodyPhysicsTestData\CollisionResolutionTestcases\4_Jumping\";
        ...
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "ThreeCubesFalling.txt", TimeStepTickRate, true, 10, 50, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = false });
