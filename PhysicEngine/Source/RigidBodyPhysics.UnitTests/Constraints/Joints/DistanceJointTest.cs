...
namespace RigidBodyPhysics.UnitTests.Constraints.Joints
{
    ...
    {
        private static string TestData = @"..\..\..\..\..\Data\TestData\RigidBodyPhysicsTestData\JointsTestcases\Distance\";
        private static float TimeStepTickRate = 50; //[ms]

        [Fact]
        public void Pendulum_SwingsAround_NoLengthChange()
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "Pendulum.txt", TimeStepTickRate, true, 100, 50, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = true });
        ...
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "suspension_bridge.txt", TimeStepTickRate, true, 100, 50, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = true });
        ...
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "DistanceJointsWithDamping.txt", TimeStepTickRate, true, 100, 50, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = true });
        ...
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "DistaneJointWithMinMax.txt", TimeStepTickRate, true, 100, 50, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = true });
