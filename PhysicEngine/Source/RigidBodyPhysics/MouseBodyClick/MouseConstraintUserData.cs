...
namespace RigidBodyPhysics.MouseBodyClick
{
    ...
    public class MouseConstraintUserData
    {
        ...
        {
            return new MouseConstraintUserData(maxForce, new SoftExportData() { ParameterType = IPublicJoint.SpringParameter.NoSoftness });
        }
        ...
        public static MouseConstraintUserData CreateWithDamping(float maxForce = 100.0f, float frequencyHertz = 5, float dampingRatio = 0.7f)
        {
            ...
            return new MouseConstraintUserData(maxForce, new SoftExportData() { ParameterType = IPublicJoint.SpringParameter.FrequenceyAndDampingRatio, FrequencyHertz = frequencyHertz, DampingRatio = dampingRatio });
        }
    }
}
