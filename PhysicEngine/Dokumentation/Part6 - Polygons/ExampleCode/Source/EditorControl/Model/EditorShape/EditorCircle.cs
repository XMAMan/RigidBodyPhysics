    ...
    internal class EditorCircle : IEditorShape
    {
        ...
        public Vec2D[] GetAnchorPoints()
        {
            return new Vec2D[]
                        {
                this.Center,
                Vec2D.RotatePointAroundPivotPoint(this.Center, new Vec2D(this.Center.X + this.radius, this.Center.Y), this.AngleInDegree),
                Vec2D.RotatePointAroundPivotPoint(this.Center, new Vec2D(this.Center.X - this.radius, this.Center.Y), this.AngleInDegree),
                Vec2D.RotatePointAroundPivotPoint(this.Center, new Vec2D(this.Center.X, this.Center.Y + this.radius), this.AngleInDegree),
                Vec2D.RotatePointAroundPivotPoint(this.Center, new Vec2D(this.Center.X, this.Center.Y - this.radius), this.AngleInDegree),
                        };
        }
    }
