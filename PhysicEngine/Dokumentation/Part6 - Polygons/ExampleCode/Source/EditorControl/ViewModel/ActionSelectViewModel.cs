...
namespace EditorControl.ViewModel
{
    ...
    {
        public enum Commands { Nothing, AddRectangle, AddCircle, AddPolygon, MoveRotate, MoveResize, CloneShape, AddDistanceJoint, AddRevoluteJoint, AddPrismaticJoint, AddWeldJoint, AddWheelJoint, LimitJoint, AddThruster, AddRotaryMotor, EditProperties, EditCollisionMatrix, Delete }
