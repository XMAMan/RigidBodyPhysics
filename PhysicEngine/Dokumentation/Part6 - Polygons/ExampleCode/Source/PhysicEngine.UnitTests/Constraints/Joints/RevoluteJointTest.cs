...
namespace PhysicEngine.UnitTests.Constraints.Joints
{
    ...
    {
        private static string TestData = @"..\..\..\..\..\Data\JointsTestcases\\Revolute\";
        ...
        public void SnapArm_NoMotorChange_PositionIsStill()
        {
            ...
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "SnapArm.txt", TimeStepTickRate, true, 100, 50, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = true });
