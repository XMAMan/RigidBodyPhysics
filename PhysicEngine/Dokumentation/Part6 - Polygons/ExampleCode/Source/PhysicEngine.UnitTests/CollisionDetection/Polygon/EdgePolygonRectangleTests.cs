...
namespace PhysicEngine.UnitTests.CollisionDetection.Polygon
{
    ...
    {
        private static string TestData = @"..\..\..\..\..\Data\CollisionDetectionTestcases\Polygon\EdgePolygonRectangle\";
        ...
        {
            int rectangle = 1;
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "OutsidePolygonRectangleSliding.txt", TimeStepTickRate, true, 50, 100, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true});
