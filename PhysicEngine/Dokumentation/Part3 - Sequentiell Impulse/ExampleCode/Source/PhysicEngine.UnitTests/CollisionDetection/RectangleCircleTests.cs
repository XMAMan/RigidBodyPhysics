...
namespace PhysicEngine.UnitTests.CollisionDetection
{
    public class RectangleCircleTests
    {
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "RectangleCircleCenterIsInside.txt");
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "RectangleCircleCorner1Collision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys); ;
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "RectangleCircleCorner2Collision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "RectangleCircleFaceCollision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "RectangleCircleCorner1NoCollision.txt");
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "RectangleCircleCorner2NoCollision.txt");
            var c = NearPhaseTests.RectangleCircle(bodys[0] as ICollidableRectangle, bodys[1] as ICollidableCircle);
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "RectangleCircleFaceNoCollision.txt");
            var c = NearPhaseTests.RectangleCircle(bodys[0] as ICollidableRectangle, bodys[1] as ICollidableCircle);
