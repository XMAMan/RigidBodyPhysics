...
namespace Part4.ViewModel.Editor
{
    ...
    {
        public enum Commands { Nothing, AddRectangle, AddCircle, MoveRotate, MoveResize, CloneShape, AddDistanceJoint, AddRevoluteJoint, AddWeldJoint,  EditProperties, Delete }
