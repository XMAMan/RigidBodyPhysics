...
namespace PhysicEngine.UnitTests.CollisionDetection
{
    public class CircleCircleTests
    {
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "CircleCircleOverlapping.txt");
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "CircleCircleSamePosition.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = ExportHelper.ReadFromFile(TestData + "CircleCircleNoCollision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
