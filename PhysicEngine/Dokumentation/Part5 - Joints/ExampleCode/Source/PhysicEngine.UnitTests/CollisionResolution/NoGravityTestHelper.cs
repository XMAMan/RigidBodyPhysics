    ...
    internal class NoGravityTestHelper
    {
        public class Body
        {
            ...
            public Body(IRigidBody body)
            {
                ...
                this.Velocity = TestHelper.MathHelper.Round(body.Velocity, roundDecimalPlaces);
                this.AngularVelocity = TestHelper.MathHelper.Round(body.AngularVelocity, roundDecimalPlaces);
                this.Position = new Vec2D(body.Center);
            }
