...
{
    internal class EditorPrismaticJoint : IEditorJoint, IJointWithLinearMinMax
    {
        ...
        public PrismaticJointPropertyViewModel Properties { get; }
        ...
        //Neu anlegen
        public EditorPrismaticJoint(IEditorShape body1, IEditorShape body2, Vec2D r1, Vec2D r2)
        {
            this.Body1 = body1;
            this.Body2 = body2;
            this.r1 = r1;
            ...
            this.Properties = new PrismaticJointPropertyViewModel();

            UpdateAfterMovingBodys();            
        }

        //Aus Datei einladen
        public EditorPrismaticJoint(PrismaticJointExportData ctor, List<IEditorShape> shapes)
        {
        ...
        {
            Vec2D a1 = Body1.Center - this.tangent;
            Vec2D a2 = Body1.Center + this.tangent;

            Vec2D b1 = a1 + this.r1Dir * this.baseLength;
            Vec2D b2 = a2 + this.r1Dir * this.baseLength;

            //Hülse
            panel.DrawLine(pen, a1.ToGrx(), a2.ToGrx());
            panel.DrawLine(pen, a1.ToGrx(), b1.ToGrx());
            panel.DrawLine(pen, a2.ToGrx(), b2.ToGrx());

            //Stift
            panel.DrawLine(new Pen(pen.Color, pen.Width + 3), Body1.Center.ToGrx(), this.r1Point.ToGrx());

            //Anchor2-Abstandslinie
