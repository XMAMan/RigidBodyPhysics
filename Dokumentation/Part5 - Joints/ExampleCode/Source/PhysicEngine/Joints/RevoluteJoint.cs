...
{
    internal class RevoluteJoint : IJoint, IPublicRevoluteJoint, IPointToPointJoint, IMinMaxAngularJoint, IAngularMotorJoint
    {
        ...
        public RevoluteJoint(RevoluteJointExportData data, List<IRigidBody> bodies)
        {
            ...
            if (this.MinMaxDifference < 0) this.MinMaxDifference += 360; //Sorge dafür, dass min<max gilt
        ...
        public IExportJoint GetExportData(List<IRigidBody> bodies)
        {
            return new RevoluteJointExportData()
            {
                ...
                MotorPosition = this.MotorPosition,
        ...
        public List<IConstraint> BuildConstraints(ConstraintConstructorData data)
        {
            ...
            if (this.LimitIsEnabled)
                list.Add(new MinMaxAngular(data, this));
