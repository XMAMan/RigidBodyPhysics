...
namespace PhysicEngine.UnitTests.CollisionDetection
{
    public class CircleCircleTests
    {
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "CircleCircleOverlapping.txt");
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "CircleCircleSamePosition.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "CircleCircleNoCollision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
