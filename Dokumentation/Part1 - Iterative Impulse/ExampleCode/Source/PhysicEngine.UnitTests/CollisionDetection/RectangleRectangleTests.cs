...
namespace PhysicEngine.UnitTests.CollisionDetection
{
    public class RectangleRectangleTests
    {
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleRectangleCollisionOnTopEdge.txt");
            var c = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleRectangleCollisionOnTopAndRightEdgeWithLongRec.txt");
            var c = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleRectangleCubeOnTableCollision.txt");
            var c = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleRectangleCubeOnTableCornerCollision.txt");
            var c = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleRectangleCubeStackOnTableCollision.txt");

            var c1 = RectangleRectangleCollision2.RectangleRectangle(bodys[0] as ICollidableRectangle, bodys[1] as ICollidableRectangle); //Tisch-Unterer Würfel
            ...
            //...
            var c2 = RectangleRectangleCollision2.RectangleRectangle(bodys[1] as ICollidableRectangle, bodys[2] as ICollidableRectangle); //Unterer Würfel - Oberer Würfel
