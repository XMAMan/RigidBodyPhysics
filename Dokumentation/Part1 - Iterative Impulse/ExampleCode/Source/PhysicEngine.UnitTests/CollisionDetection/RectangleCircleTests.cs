...
namespace PhysicEngine.UnitTests.CollisionDetection
{
    public class RectangleCircleTests
    {
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleCircleCenterIsInside.txt");
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleCircleCorner1Collision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleCircleCorner2Collision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleCircleFaceCollision.txt");
            var collisions = CollisionHelper.GetAllCollisions(bodys);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleCircleCorner1NoCollision.txt");
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleCircleCorner2NoCollision.txt");
            var c = NearPhaseTests.RectangleCircle(bodys[0] as ICollidableRectangle, bodys[1] as ICollidableCircle);
        ...
        {
            var bodys = JsonHelper.ReadFromFile(TestData + "RectangleCircleFaceNoCollision.txt");
            var c = NearPhaseTests.RectangleCircle(bodys[0] as ICollidableRectangle, bodys[1] as ICollidableCircle);
