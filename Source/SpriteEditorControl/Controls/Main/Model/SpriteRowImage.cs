...
namespace SpriteEditorControl.Controls.Main.Model
{
    internal class SpriteRowImage : ITimerHandler
    {
        ...
        public void Draw(IDrawingPanel panel, float x, float y, int pivotX, int pivotY, float zoom, float rotateZAngleInDegree, float rotateYAngleInDegree, bool showBoundingBox)
        {
            panel.PushMatrix();
