...
{
    //Diese Constraint sorgt dafür, dass die beiden Ankerpunkte immer den Abstand DistanceJoint.LengthPosition haben
    ...
    internal class DistanceJointConstraint : ISoftConstraint1D
    {
        ...
        public DistanceJointConstraint(ConstraintConstructorData data, DistanceJoint joint)
        {
            ...
            this.PositionError = length - joint.LengthPosition;
