...
namespace RigidBodyPhysics.UnitTests.CollisionResolution
{
    ...
    {
        private static string TestData = @"..\..\..\..\..\Data\TestData\RigidBodyPhysicsTestData\CollisionResolutionTestcases\2_RestingContact\";
        ...
        public void CubeOnTable_StartsWithMomentum_BecomesQuickResting()
        {
            ...
            var angle_0_1 = SimulateSeveralTimeSteps
                .DoTest(TestData + "CubeOnTableWithMomentum.txt", TimeStepTickRate, true, 100, 100, true, new SimulateSeveralTimeSteps.ExtraSettings()
