...
namespace RigidBodyPhysics.UnitTests.CollisionResolution
{
    ...
    {
        private static string TestData = @"..\..\..\..\..\Data\TestData\RigidBodyPhysicsTestData\CollisionResolutionTestcases\5_PGSConvergence\";
        ...
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "CubeStack.txt", TimeStepTickRate, true, 10, 100, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = true });
        ...
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "CubeStack.txt", TimeStepTickRate, true, 10, 100, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = false });
        ...
        {
            int smallBall = 1;
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "HeaveBallStack.txt", TimeStepTickRate, true, 10, 500, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = true });
        ...
        {
            int smallBall = 1;
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "HeaveBallStack.txt", TimeStepTickRate, true, 10, 500, true, new SimulateSeveralTimeSteps.ExtraSettings() { DoPositionCorrection = true, DoWarmStart = false });
