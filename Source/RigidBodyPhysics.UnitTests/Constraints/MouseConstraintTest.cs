...
namespace RigidBodyPhysics.UnitTests.Constraints
{
    ...
    {
        private static string TestData = @"..\..\..\..\..\Data\TestData\RigidBodyPhysicsTestData\JointsTestcases\Mouse\";
        ...
        {
            var result = SimulateSeveralTimeSteps.DoTest(TestData + "CubesWithDifferentMass.txt", TimeStepTickRate, true, 10, 5, true, new SimulateSeveralTimeSteps.ExtraSettings()
            {
