...
namespace RigidBodyPhysics.UnitTests.TestHelper
{
    ...
    internal class SimulateSeveralTimeSteps
    {
        ...
        public static SimulateSeveralTimeSteps DoTest(string sceneFilePath, float timeStepTickRate, bool useGlobalSolver, int pgsIterations = 100, int timeSteps = 50, bool hasGravity = true, ExtraSettings extraSettings = null)
        {
        ...
        //Input: [0, 0, 0, 0, 0, x1, x2, x3, x4] mit (x != 0)
        //Return: [x1, x2, x3, x4]
        public static float[] SkipFirstZeros(float[] signal)
        {
            int j = 0;
