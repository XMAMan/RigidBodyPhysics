...
namespace AstroidsControl.Model
{
    ...
    class FireSprite : ITimerHandler
    {
        ...
        public FireSprite(string dataFolder, AnchorPoint anchorPoint1, AnchorPoint anchorPoint2)
        {
            ...
            var localAnchor1 = new Vec2D(222, 259); //An diesem Pixel befindet sich die rechte untere Ecke vom Feuer
            var localAnchor2 = new Vec2D(59, 259);  //An diesem Pixel befindet sich die linke untere Ecke vom Feuer
        ...
        public void HandleTimerTick(float dt)
        {
            ...
            this.sprite.RotateZAngleInDegree = 360 - Vec2D.Angle360(p1 - p2, new Vec2D(1, 0)) + 180;
