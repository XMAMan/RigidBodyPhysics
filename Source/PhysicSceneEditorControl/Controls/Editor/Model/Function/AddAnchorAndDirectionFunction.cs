...
{
    internal abstract class AddAnchorAndDirectionFunction : DummyFunction, IFunction
    {
                ...
                case Mode.PlaceDirection:
                    {
                        ...
                        CreateNewObject(shape, r1, forceDirection);
        ...
        protected abstract void CreateNewObject(IEditorShape shape, Vec2D r1, Vec2D forceDirection);
        ...
        public override void Draw(GraphicPanel2D panel)
        {
            ...
            if (mode == Mode.PlaceDirection)
            {
                ...
                DrawObject(panel, this.anchor, dir);
            }
        }
