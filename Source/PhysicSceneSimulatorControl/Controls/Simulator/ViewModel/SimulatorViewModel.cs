...
using System.IO;
using PhysicSceneSimulatorControl.Controls.ManipulateJoint.JointSelector;

namespace PhysicSceneSimulatorControl.Controls.Simulator.ViewModel
{
    public class SimulatorViewModel : ReactiveObject, IGraphicPanelHandler, IStringSerializable, ITimerHandler
    {
        ...
        private PrintSettingsViewModel printSettings = new PrintSettingsViewModel();
        ...
        public SimulatorViewModel(EditorInputData data)
        {
            ...
            {
                DoSingleTimeStep(data.TimerTickRateInMs);
            });
        ...
        public void HandleMouseDown(System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (data != null)
            {
                var mouseData = this.shiftIsPressed ? RigidBodyPhysics.MouseBodyClick.MouseConstraintUserData.CreateWithDamping() : RigidBodyPhysics.MouseBodyClick.MouseConstraintUserData.CreateWithoutDamping();
        ...
        public void LoadFromExportObject(object exportObject)
        {
            ...
            this.ManipulateJointControl = new JointSelectorControl() { DataContext = new JointSelectorViewModel(this.model.GetAllJoints(), this.model.GetAllThrusters(), this.model.GetAllRotaryMotors()) };
        }
